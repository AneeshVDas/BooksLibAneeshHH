...
var BookDetailsComponent = /** @class */ (function () {
    function BookDetailsComponent(router, route, bookService, helperService) {
        this.router = router;
        this.route = route;
        this.bookService = bookService;
